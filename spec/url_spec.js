...
describe("url", function() {
  it(
    ...
    function() {
      ...
      var generated_url = url.issues(project, component, work_group,
  ...
  it(
    ...
    function() {
      ...
      var generated_url = url.issues(project, component, null, null, user,
        password);
  ...
  it(
    ...
    function() {
      ...
      var generated_url = url.control_chart(control_chart, user, password,
        from, to);
