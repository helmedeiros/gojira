...
describe('config', function () {
    it('loads a JSON file from disk', function () {
        var loaded = config.load('./spec/jasmine/fixtures/sample_config.json');
    ...
    it('coerces points_per_day to number', function () {
        var loaded = config.load('./spec/jasmine/fixtures/points_per_day_string.json');
    ...
    it('coerces first_column_to_count to integer', function () {
        var loaded = config.load('./spec/jasmine/fixtures/first_column_string.json');
    ...
    it('throws on an unsupported output_format', function () {
        expect(function () {
            config.load('./spec/jasmine/fixtures/bad_format.json');
